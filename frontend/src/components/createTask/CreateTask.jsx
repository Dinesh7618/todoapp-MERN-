...
function CreateTask() {
    ...
    const [dueDate, setDueDate] = useState(""); // Default due date
    ...
    const handleAdd = async (e) => {
        ...
        dispatch({
            ...
            title,
            description,
            priority, // Include priority in the action
            dueDate, // Include due date in the action
        });

        setTitle("");
        setDescription("");
        setPriority("medium"); // Reset priority to the default
        setDueDate(""); // Reset due date to the default
    }
